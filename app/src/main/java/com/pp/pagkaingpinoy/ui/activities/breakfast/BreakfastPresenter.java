...
public class BreakfastPresenter implements OnSingleItemClickListener {
  ...
  public void initBreakfastList() {
    ...
    DatabaseReference breakfastReferences =
        FirebaseDatabase.getInstance().getReference().child(AppConstants.BREAKFAST_MENU);
    breakfastReferences.addValueEventListener(new ValueEventListener() {
      @Override public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        activity.setBreakfastList(menuList);
      }
